...
define('DB_USER', getenv('TODOLIST_DB_PASS'));
define('DB_PASS', getenv('TODOLIST_DB_PASS'));
define('DB_NAME', getenv('TODOLIST_DB_PASS'));
define('DB_HOST', getenv('TODOLIST_DB_PASS'));
define('DB_PORT', getenv('TODOLIST_DB_PASS'));
